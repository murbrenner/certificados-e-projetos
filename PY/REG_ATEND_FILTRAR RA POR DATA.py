...
for i in df.index:
    ...
    driver.find_element(By.NAME, "periodoAtendimentoInicial").send_keys(str(df['INICIO'][i]))
    driver.find_element(By.NAME, "periodoAtendimentoFinal").clear()
    driver.find_element(By.NAME, "periodoAtendimentoFinal").send_keys(str(df['FIM'][i]))
