...
for i in df.index:
    caminho = r"C:\\Users\\ocmvc45555\\Desktop\\CADASTRAMENTO DE IMOVEL\\{}".format(str(df['RA'][i]))
    ...
    os.renames(latest_file, "C:\\Users\\ocmvc45555\\Downloads\\R.A.PDF")
    latest_file = "C:\\Users\\ocmvc45555\\Downloads\\R.A.PDF"
