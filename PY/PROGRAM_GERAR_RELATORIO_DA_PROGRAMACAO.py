...
import csv
from db_fiscais import num_nomes_joined
...
with open(teste, mode="w", newline="") as teste:
    ...
    for f in df:
        try:
            today = "24/10/2024"#datetime.today().strftime("%d/%m/%Y")
        ...
        try:
            while n < 30:
                ...
                count = n - 2
                linha = num_nomes_joined[f], reg_atend, ord_serv, tipo_serv, today, status_serv
                n = n + 1
