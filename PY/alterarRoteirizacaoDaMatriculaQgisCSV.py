...
df = pd.read_csv(relatorioQgis)
login()

relatorioGsan = relatorioPlan
                    ...
                    try:
                        ...
                        try:                    
                            ...
                            try:     
                                ...
                                #print(i + 1, matricula, msg5)
                                row = i + 1, matricula, msg5
                                writer.writerow(row)
                        
            elif matricula == 0:
                msg6 = "matricula zerada"            
                #print(i + 1, matricula, msg6)
                row = i + 1, matricula, msg6
                writer.writerow(row)
                pass
        elif alterar == 0:     
            msg7 = "NÃO ALTERAR"
            #print(i + 1, matricula, msg7)
