...
while rota <= rotas:
    ...
    idLocalidade = '926'
    codigoSetorComercial = '400'
    codigoRota = rota
    faturamentoGrupo = '925'#idLocalidade
    cobrancaGrupo = '925'#idLocalidade
    leituraTipo = 'IMPRESSAO SIMULTANEA'    
    empresaLeituristica = 'GSH'
    empresaCobranca = 'CAEMA'
    empresaEntregaContas = 'GSH'   
    idLeiturista = '884668'
