...
while rota <= rotas:      
    ...
    codigoRota = rota
    faturamentoGrupo = 150 #idLocalidade#Keys.END
    cobrancaGrupo = 150 #idLocalidade#Keys.END
    leituraTipo = 'MICROCOLETOR'#'IMPRESSAO SIMULTANEA'    
    ...
    time.sleep(0.5)
    driver.get("http://g1.caema.ma.gov.br/gsan/exibirInserirRotaAction.do?menu=sim")
