...
while num < total:
    ...
    oos = driver.find_element(By.XPATH,
                              "/html/body/form/table[3]/tbody/tr/td[2]/table[3]/tbody/tr[2]/td/table/tbody/tr[3]/td/table/tbody/tr[3]/td/div/table/tbody/tr[{}]/td[1]/input".format(
                                  num)).get_attribute('value')
    driver.find_element(By.XPATH, "//input[@value='{}']".format(oos)).click()
    rra = driver.find_element(By.XPATH,
                              "/html/body/form/table[3]/tbody/tr/td[2]/table[3]/tbody/tr[2]/td/table/tbody/tr[3]/td/table/tbody/tr[3]/td/div/table/tbody/tr[{}]/td[7]/div/a".format(
                                  num)).text
    ...
    with open(file_path, 'w', newline='') as csv_file:
        ...
        if findlocal == '111':
            ...
            print('GRUPO ALSAN 183 NAO TEM MAPA', end=',')
            pass
        else:
            print('ERRO')
