...
from arquivos import prog_fisc, teste
from fiscais import fiscais, nomes_sep_join, name_to_value
import time
...
for i in df.index:
    try:
        ...
        if sit_os == "Pendente":
            ...
            driver.find_element(By.XPATH, "//option[@value='{}']".format(fiscal2)).click()
            ...
            print(i + 1, "ORDEM DE SERVIÇO {} [REPROGRAMADA] COM SUCESSO PARA O FISCAL [{}] PRO DIA [{}]!".format(str(df['OS'][i]), fiscal, data_prog))
