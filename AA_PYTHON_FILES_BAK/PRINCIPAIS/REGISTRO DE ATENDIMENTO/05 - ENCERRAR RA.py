...
import pandas as pd
from login import murilo2, driver, login
...
for i in df.index:
    ...
    if sit_ra == 'Pendente':
        ...
        try:
            ...
            driver.find_element(By.NAME, "parecerEncerramento").send_keys('ABERTA EQUIVOCADAMENTE. CORTE EM ANDAMENTO.')#CANCELAMENTO PELA CAEMA
        except:
            pass
