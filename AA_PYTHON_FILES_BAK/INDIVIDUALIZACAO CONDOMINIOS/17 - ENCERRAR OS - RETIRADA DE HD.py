    ...
    if sit_os == 'Encerrada':
        ...
        try:
            ...
            if leitura == 0:
                ...
                driver.find_element(By.NAME, "numeroLeitura").send_keys(str(df['LEITURA'][i]))
            driver.find_element(By.NAME, "idHidrometroSituacao").send_keys('DISPONIVEL')
            driver.find_element(By.NAME, "hidrometroLocalArmazenagem").send_keys('ESTOQUE')
