...
with open(teste, mode="w", newline="") as teste:
    ...
    for i in df.index:
        ...
        #driver.find_element(By.NAME, "unidade").send_keys('38', Keys.ENTER)
        driver.find_element(By.NAME, "tipoSolicitacao").send_keys('2.07')
        driver.find_element(By.NAME, "especificacao").send_keys('RETIRAR HIDROMETRO DO SISTEMA')
